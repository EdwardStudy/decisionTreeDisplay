			...
			var defaultOption = function () {
				...
				this.infoBox = {
					...
					getinfos:       function (d) {
						...
						var p = "";
						var line_number = 0;
						var traverse = function (obj, index) {
							if (obj) {
								//重新排序
								...
								for (var i in obj) {
									if (obj[i].display) {
										p = obj[i].name + " = " + obj[i].formula;
										str += "<p class='info-box-p' pid='"+ obj[i].pid +"'>" + p + "</p>";
									} else {
										str += "<p class='info-box-p' pid='"+ obj[i].pid +"'></p>";
									}
									line_number++;
								}
							}
