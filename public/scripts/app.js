define([
	...
	var app = angular.module('app', [
					...
					$http.get('/signedin').success(function (user) {
						...
						if (user !== '0') {
							...
							$rootScope.project = {
								...
								project_name : $stateParams.project_name
							};
		...
		//全局控制器
		.controller('AppCtrl', [
			'$scope', '$state', '$stateParams', '$location', function ($scope, $rootScope, $state, $stateParams, $location) {
				$scope.main = {
					brand: 'DTree'
				}

//				$scope.$on("changeProject", function(e, m){
//					console.log("changeProject", m);
//					$scope.$broadcast("AppChangeProject", m);
//				})
			}
		])
		.controller('NavCtrl', [
