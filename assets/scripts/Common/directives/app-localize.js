(function () {
    ...
    angular.module('app.localization', []).factory('localize', [
        ...
        'localize', function (localize) {
            ...
            i18nDirective = {
                restrict: "EA",
                scope : {displayArea: "@displayArea"},
                updateText: function (ele, input, placeholder, displayArea) {
                    ...
                    if (input === 'i18n-placeholder') {
                        ...
                        if(displayArea != '')
                            return $(ele).attr(displayArea, result);
                ...
                link: function (scope, ele, attrs) {
                    scope.$on('localizeResourcesUpdated', function () {
                        return i18nDirective.updateText(ele, attrs.i18n, attrs.placeholder, scope.displayArea);
                    });
                    return attrs.$observe('i18n', function (value) {
                        return i18nDirective.updateText(ele, value, attrs.placeholder, scope.displayArea);
                    });
                }
            };
